...
@php
    $randomId = 'textarea-' . Str::random(10);
@endphp

<div x-data="{ textAreaLength: 0 }" class="relative {{ $attributes->get('class') }}">
    <textarea x-ref="{{ $randomId }}" x-on:input="textAreaLength = $event.target.value.length"
