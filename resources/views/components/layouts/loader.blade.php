{{ $slot }}
<div wire:loading.class="opacity-100" wire:loading.remove.class="pointer-events-none" wire:loading.delay.longer
    class="pointer-events-none fixed inset-0 bg-black/50 z-100 content-center justify-items-center text-white transition-opacity opacity-0 duration-200">
        ...
        <g>
            <rect fill="#e15b64" height="20" width="20" y="19" x="19">
                <animate calcMode="discrete" begin="0s" repeatCount="indefinite" dur="1s" keyTimes="0;0.125;1"
                    values="#f8b26a;#e15b64;#e15b64" attributeName="fill"></animate>
            </rect>
