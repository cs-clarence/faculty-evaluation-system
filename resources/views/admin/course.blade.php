            ...
            <div class="col-span-1 md:col-span-3 overflow-auto">
                <table class="min-w-full bg-white rounded-lg overflow-hidden shadow-md">
                    ...
                    <tbody class="text-gray-700">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="py-3 px-4 text-center text-gray-500">No subjects found</td>
                            </tr>
                        @endforelse
                    </tbody>
                ...
                <div class="bg-white p-6 rounded-lg w-96">
                    ...
                    <form id="addSubjectForm" method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="course_code" id="course_code" required class="w-full px-3 py-2 border rounded-lg">
                        </div>
                   ...
                   <!-- <input type="hidden" name="subjects[]" id="subjectsInput">   -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="course_name" id="course_name" required class="w-full px-3 py-2 border rounded-lg">
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        dropdown.addEventListener('change', function() {
            ...
            if (!selectedSubjects.includes(selectedValue)) {
                ...
                subjectTag.className = 'inline-block bg-blue-200 text-blue-800 px-2 py-1 rounded-full m-1';
