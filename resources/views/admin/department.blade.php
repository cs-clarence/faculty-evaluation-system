                ...
                <div class="bg-white p-6 rounded-lg w-96">
                    ...
                    <form id="addSubjectForm" method="POST" action="{{route('department.store')}}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="department_code" id="subjectID" required class="w-full px-3 py-2 border rounded-lg">
                        </div>
                        <div class="mb-4">
                            <label for="department_name" class="block text-gray-700">Department Name</label>
                            <input type="text" name="department_name" id="subjectName" required class="w-full px-3 py-2 border rounded-lg">
                        </div>
