        ...
        <div class="col-span-1 md:col-span-3 overflow-auto">
            @php
                $columns = [
                    ...
                    ['label' => 'Department', 'render' => 'dean.department.name'],
                    [
                        'label' => 'Actions',
                ...
                <x-dialog.content>
                    <x-forms.user-form-fields :departments="$departments">
                        @if ($form->include_base)
                            <input type="hidden" name="role_code" value="{{ RoleCode::Dean->value }}" />
