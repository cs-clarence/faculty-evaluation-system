<div class="contents">
    <div class="top flex justify-end mb-4">
        <button wire:click='openAddModal' id="addButton"
    ...
    @if ($addModalOpen)
        <div id="addModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center"
            wire:click='closeAddModal'>
            <div class="bg-white p-6 rounded-lg w-96">
                <h3 class="text-lg font-semibold mb-4">Add New School Year</h3>
                <form id="addForm" wire:submit.prevent='store'>
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="year_end" id="year_end" required
                            class="w-full px-3 py-2 border rounded-lg" type="number" value="{{ old('year_end') }}">
                        @error('year_end')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
